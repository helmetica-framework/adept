...
// ExtractDefinitionFrom extracts the applied configuration owned by fieldManager from
// definition for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// definition must be a unmodified Definition API object that was retrieved from the Kubernetes API.
// ExtractDefinitionFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractDefinitionFrom(definition *apiv1.Definition, fieldManager string, subresource string) (*DefinitionApplyConfiguration, error) {
	b := &DefinitionApplyConfiguration{}
	err := managedfields.ExtractInto(definition, internal.Parser().Type("com.github.helmetica-framework.adept.api.v1.Definition"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(definition.Name)
	b.WithNamespace(definition.Namespace)
...
// ExtractDefinition extracts the applied configuration owned by fieldManager from
// definition. If no managedFields are found in definition for fieldManager, a
// DefinitionApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// definition must be a unmodified Definition API object that was retrieved from the Kubernetes API.
// ExtractDefinition provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractDefinition(definition *apiv1.Definition, fieldManager string) (*DefinitionApplyConfiguration, error) {
	return ExtractDefinitionFrom(definition, fieldManager, "")
}

func (b DefinitionApplyConfiguration) IsApplyConfiguration() {}
...
func (b *DefinitionApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *DefinitionApplyConfiguration) GetAPIVersion() *string {
...
func (b *DefinitionApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
