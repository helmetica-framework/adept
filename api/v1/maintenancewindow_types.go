...
// MaintenanceWindowSpec declares a recurring span in which maintenance may
// start. The span opens at Time on each day listed in DaysOfWeek, read as wall
// clock in TimeZone, and stays open for Duration.
//
// Instances sharing a window are spread across the span by an offset derived
...
type MaintenanceWindowSpec struct {
	...
	// Duration is the span during which maintenance may start, between 1h and
	...
	// the span keeps going until it finishes, which may be well after the span
	// has closed.
